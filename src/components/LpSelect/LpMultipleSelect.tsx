...
interface ILpMultipleSelectProps<T extends FieldValues> {
    label: string;
    name: Path<T>;
    control?: Control<T>;
...
const LpMultipleSelect = <T extends FieldValues>({label, name, control, options}: ILpMultipleSelectProps<T>) => {
    return (
        <>
            <FormControl>
...
export default LpMultipleSelect;